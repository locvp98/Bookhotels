...
class DiscoveryCityAdapter(var context: Context, var citylist: ArrayList<AllCity>) :
    androidx.recyclerview.widget.RecyclerView.Adapter<DiscoveryCityAdapter.RecycleviewHodel>() {
